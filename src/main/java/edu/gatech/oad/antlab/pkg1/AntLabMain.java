 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Kaliq Wang");
		  toPrint += p1.toString("kwang325");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Max Yang");
		  toPrint += p2.toString("myang300");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Rayner Kristanto");
		  toPrint += p3.toString("rkristanto3");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Bongkyun Kang");
          toPrint += p4.toString("bkang44");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("William Anderson");
          toPrint += p5.toString("wanderson43");
